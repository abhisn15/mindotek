...
interface SimpleStickyScrollProps {
  content: ContentItem[];
}

export default function SimpleStickyScroll({ content }: SimpleStickyScrollProps) {
  ...
  return (
    <div ref={targetRef} className="relative bg-white">
