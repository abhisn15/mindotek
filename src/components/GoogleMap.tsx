        ...
        {locations.map((location) => (
          ...
          >
            <div className="flex items-start">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center mr-3 shadow-md transition-all duration-300 ${
                selectedLocation.id === location.id
              ...
              <div className="flex-1">
                <h3 className={`font-bold mb-1 transition-colors ${
                  selectedLocation.id === location.id ? 'text-red-600' : 'text-gray-900 group-hover:text-red-600'
                }`}>{location.city}</h3>
        ...
        <div className="mt-8 bg-gradient-to-br from-red-50 via-orange-50 to-white rounded-2xl p-8 shadow-2xl border-2 border-red-100">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-red-100">
              ...
              <p className="text-gray-900 font-semibold text-lg">{selectedLocation.city}</p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-red-100">
              <span className="text-gray-600 font-medium text-sm">Region</span>
              <p className="text-gray-900 font-semibold text-lg">{selectedLocation.region}</p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-red-100 sm:col-span-2">
              ...
              <p className="text-gray-900 font-semibold">{selectedLocation.address}</p>
            </div>
          </div>
